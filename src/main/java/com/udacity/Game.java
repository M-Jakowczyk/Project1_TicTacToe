...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        for (int s = 0; s < symbol.length; s++) {
            ...
            if (grid[0][0] == symbol[s] && grid[1][1] == symbol[s] && grid[2][2] == symbol[s] ||
                    grid[0][2] == symbol[s] && grid[1][1] == symbol[s] && grid[2][0] == symbol[s] ||
                    grid[0][0] == symbol[s] && grid[0][1] == symbol[s] && grid[0][2] == symbol[s] ||
                    grid[1][0] == symbol[s] && grid[1][1] == symbol[s] && grid[1][2] == symbol[s] ||
                    grid[2][0] == symbol[s] && grid[2][1] == symbol[s] && grid[2][2] == symbol[s] ||
                    grid[0][0] == symbol[s] && grid[1][0] == symbol[s] && grid[2][0] == symbol[s] ||
                    grid[0][1] == symbol[s] && grid[1][1] == symbol[s] && grid[2][1] == symbol[s] ||
                    grid[0][2] == symbol[s] && grid[1][2] == symbol[s] && grid[2][2] == symbol[s]) {
                result = symbol[s] + " wins";
            }
